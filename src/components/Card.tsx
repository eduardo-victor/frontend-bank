...
const Card = (props: GetProps) => {
  return (
    <div className='w-[90%] h-[15vh] drop-shadow-md bg-white rounded-md flex flex-row items-center hover:transition-all hover:-translate-y-2 hover:duration-150 hover:ease-in-out'>
